...
/*
let getDistrictSesion = async function (req, res) {
    try{
    ...
    //  console.log(`query params are: ${district} ${date}`)
        let options = {
            method: "get",
            url: `https://cdn-api.co-vin.in/v2/appointment/sessions/public/findByDistrict?
...
// module.exports.getDistrictSesion=getDistrictSesion
